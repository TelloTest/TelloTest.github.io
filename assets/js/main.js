  ...
  $('.js-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Comment submitted', 'Thanks! Your comment is <a href="https://github.com/TelloVisionGames/TelloVisionGames.github.io/pulls">pending</a>. It will appear when approved.');
